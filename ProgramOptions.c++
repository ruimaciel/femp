/* Generated by re2c 0.13.5 on Sun Nov 29 16:19:22 2009 */
...
void ProgramOptions::setOption(const std::string option, bool value, Option::OPTIONS_LEVEL level)
{
	Option op;
	op.setOption(value, level);
	(*this)[option] = op;
		...
		switch(state)
		{
			...
			case 7:	// wait for EOL before committing bool
				switch(token)
				{
					case LEX_EOL:
						line++;
						op.setOption(temp, value.b, level);
						temp.clear();
						opname.clear();	//TODO implement support the compact format
						state = 0;
						break;
