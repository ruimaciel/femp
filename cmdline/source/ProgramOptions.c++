/* Generated by re2c 0.13.5 on Sun Mar 28 21:04:24 2010 */
...
#line 276 "../../source/ProgramOptions.c++"
{
	char yych;
...
#line 322 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 315 "../../source/ProgramOptions.c++"
yy4:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy158;
...
#line 376 "../../source/ProgramOptions.c++"
yy15:
	++p;
...
#line 381 "../../source/ProgramOptions.c++"
yy17:
	++p;
	yych = (char)*p;
	goto yy21;
...
#line 389 "../../source/ProgramOptions.c++"
yy19:
	yych = (char)*++p;
	goto yy3;
yy20:
...
#line 684 "../../source/ProgramOptions.c++"
yy82:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy83;
...
#line 696 "../../source/ProgramOptions.c++"
yy85:
	++p;
...
#line 828 "../../source/ProgramOptions.c++"
yy112:
	++p;
...
#line 284 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 1026 "../../source/ProgramOptions.c++"
yy158:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy159;
...
#line 1073 "../../source/ProgramOptions.c++"
yy167:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy168;
...
#line 1189 "../../source/ProgramOptions.c++"
yy187:
	yych = (char)*++p;
	switch (yych) {
	case 's':	goto yy188;
...
#line 282 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS;	}
#line 1200 "../../source/ProgramOptions.c++"
yy190:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy191;
...
#line 281 "../../source/ProgramOptions.c++.re2c"
	{ return S_VERSION;	}
#line 1235 "../../source/ProgramOptions.c++"
yy197:
	yych = (char)*++p;
	switch (yych) {
	case 'l':	goto yy198;
...
#line 1262 "../../source/ProgramOptions.c++"
{
	char yych;
	yych = (char)*p;
	switch (yych) {
...
#line 371 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 1300 "../../source/ProgramOptions.c++"
yy205:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy359;
...
#line 367 "../../source/ProgramOptions.c++.re2c"
	{ return S_SUBARG_SEPARATOR; }
#line 1361 "../../source/ProgramOptions.c++"
yy216:
	++p;
...
#line 1366 "../../source/ProgramOptions.c++"
yy218:
	++p;
	yych = (char)*p;
	goto yy222;
...
#line 369 "../../source/ProgramOptions.c++.re2c"
	{ return S_INTEGER;	}
#line 1374 "../../source/ProgramOptions.c++"
yy220:
	yych = (char)*++p;
	goto yy204;
yy221:
...
#line 360 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE4;}
#line 1422 "../../source/ProgramOptions.c++"
yy229:
	++p;
#line 361 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE5;}
#line 1427 "../../source/ProgramOptions.c++"
yy231:
	++p;
#line 362 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE6;}
#line 1432 "../../source/ProgramOptions.c++"
yy233:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy234;
...
#line 341 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM6;}
#line 1546 "../../source/ProgramOptions.c++"
yy256:
	++p;
#line 348 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM18;}
#line 1551 "../../source/ProgramOptions.c++"
yy258:
	++p;
#line 352 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM15;}
#line 1556 "../../source/ProgramOptions.c++"
yy260:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy261;
...
#line 1669 "../../source/ProgramOptions.c++"
yy283:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy284;
...
#line 1681 "../../source/ProgramOptions.c++"
yy286:
	++p;
...
#line 1813 "../../source/ProgramOptions.c++"
yy313:
	++p;
...
#line 1953 "../../source/ProgramOptions.c++"
yy346:
	yych = (char)*++p;
	switch (yych) {
	case 'n':	goto yy347;
...
#line 336 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_LINE2;}
#line 1977 "../../source/ProgramOptions.c++"
yy351:
	++p;
...
#line 334 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 2011 "../../source/ProgramOptions.c++"
yy359:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy360;
...
#line 333 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_STIFFNESS;	}
#line 2058 "../../source/ProgramOptions.c++"
yy368:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy369;
...
#line 332 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS;	}
#line 2095 "../../source/ProgramOptions.c++"
yy375:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy376;
...
#line 331 "../../source/ProgramOptions.c++.re2c"
	{ return S_VERSION;	}
#line 2130 "../../source/ProgramOptions.c++"
yy382:
	yych = (char)*++p;
	switch (yych) {
	case 'l':	goto yy383;
