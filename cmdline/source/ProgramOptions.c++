/* Generated by re2c 0.13.5 on Tue Mar 30 12:01:00 2010 */
...
enum ProgramOptions::Option ProgramOptions::setCommandLineOptions(int argc, char **argv, fem::Analysis &analysis)
{
	...
	table[SN_SET_OPTION_FOLLOW][S_IPS]	= 7;	
	table[SN_SET_OPTION_FOLLOW][S_OUTPUT_FEM_EQUATION]	= 7;	
	...
	table[SG_IPS_STIFFNESS_ASSIGN][S_EOA]	= 17;
	table[SG_IPS_STIFFNESS_ASSIGN][S_EOL]	= 17;

	table[SG_IPS_DOMAIN_ASSIGN][S_EOA]	= 19;
	table[SG_IPS_DOMAIN_ASSIGN][S_EOL]	= 19;

	table[SN_IPS_FOLLOW_S_ASSIGN][S_FE_ELEMENT]	= 18;
	...
	table[SN_IPS_FOLLOW_D_ASSIGN][S_FE_ELEMENT] = 20;
	...
	table[SG_OUTPUT_EQUATION_ASSIGN][S_EOA] = 42;
	table[SG_OUTPUT_EQUATION_ASSIGN][S_EOL] = 42;
	...
	while(ss.size() > 0)
	{
		...
		else
		{
			...
			switch(table[ss.top()][symbol])
			{
				...
				case 7:	// <set option follow>	::= <set option> <set option follow> 
					ss.pop();
				...
				case 17: //<G IPs stiffness assign> ::=
					ss.pop();
				...
				case 18: // <IPs follow stiffness assignment>	::= <IPs first assignment> <G IPs stiffness assign> <end field>
					ss.pop();
					ss.push(SN_END_FIELD);
					ss.push(SG_IPS_STIFFNESS_ASSIGN);
					ss.push(SN_IPS_FIRST_ASSIGN);
				...
				case 20: // <IPs follow domain assignment>	::= <IPs first assignment> <G IPs domain assign> <end field>
					ss.pop();
					ss.push(SN_END_FIELD);
					ss.push(SG_IPS_DOMAIN_ASSIGN);
					ss.push(SN_IPS_FIRST_ASSIGN);
				...
				case 42: // <G output equation assign>	::= 
					ss.pop();
...
#line 258 "../../source/ProgramOptions.c++"
{
	char yych;
...
#line 304 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 297 "../../source/ProgramOptions.c++"
yy4:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy158;
...
#line 358 "../../source/ProgramOptions.c++"
yy15:
	++p;
...
#line 363 "../../source/ProgramOptions.c++"
yy17:
	++p;
	yych = (char)*p;
	goto yy21;
...
#line 371 "../../source/ProgramOptions.c++"
yy19:
	yych = (char)*++p;
	goto yy3;
yy20:
...
#line 666 "../../source/ProgramOptions.c++"
yy82:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy83;
...
#line 266 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 1008 "../../source/ProgramOptions.c++"
yy158:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy159;
...
yy165:
	++p;
#line 265 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_STIFFNESS;	}
#line 1055 "../../source/ProgramOptions.c++"
yy167:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy168;
...
#line 1171 "../../source/ProgramOptions.c++"
yy187:
	yych = (char)*++p;
	switch (yych) {
	case 's':	goto yy188;
...
#line 264 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS;	}
#line 1182 "../../source/ProgramOptions.c++"
yy190:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy191;
...
#line 262 "../../source/ProgramOptions.c++.re2c"
	{ return S_HELP;	}
#line 1234 "../../source/ProgramOptions.c++"
}
...
#line 1244 "../../source/ProgramOptions.c++"
{
	char yych;
	yych = (char)*p;
	switch (yych) {
...
#line 353 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 1282 "../../source/ProgramOptions.c++"
yy205:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy359;
...
#line 349 "../../source/ProgramOptions.c++.re2c"
	{ return S_SUBARG_SEPARATOR; }
#line 1343 "../../source/ProgramOptions.c++"
yy216:
	++p;
...
#line 1348 "../../source/ProgramOptions.c++"
yy218:
	++p;
	yych = (char)*p;
	goto yy222;
...
#line 351 "../../source/ProgramOptions.c++.re2c"
	{ return S_INTEGER;	}
#line 1356 "../../source/ProgramOptions.c++"
yy220:
	yych = (char)*++p;
	goto yy204;
yy221:
...
#line 343 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE5;}
#line 1409 "../../source/ProgramOptions.c++"
yy231:
	++p;
#line 344 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE6;}
#line 1414 "../../source/ProgramOptions.c++"
yy233:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy234;
...
#line 323 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM6;}
#line 1528 "../../source/ProgramOptions.c++"
yy256:
	++p;
#line 330 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM18;}
#line 1533 "../../source/ProgramOptions.c++"
yy258:
	++p;
#line 334 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM15;}
#line 1538 "../../source/ProgramOptions.c++"
yy260:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy261;
...
#line 1581 "../../source/ProgramOptions.c++"
yy268:
	++p;
#line 331 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PYRAMID14;}
#line 1586 "../../source/ProgramOptions.c++"
yy270:
	++p;
...
#line 1651 "../../source/ProgramOptions.c++"
yy283:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy284;
...
#line 1663 "../../source/ProgramOptions.c++"
yy286:
	++p;
#line 329 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_HEXAHEDRON27;}
#line 1668 "../../source/ProgramOptions.c++"
yy288:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy289;
...
#line 1795 "../../source/ProgramOptions.c++"
yy313:
	++p;
#line 326 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_TRIANGLE6;}
#line 1800 "../../source/ProgramOptions.c++"
yy315:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy321;
...
#line 1818 "../../source/ProgramOptions.c++"
yy319:
	++p;
...
#line 318 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_LINE2;}
#line 1959 "../../source/ProgramOptions.c++"
yy351:
	++p;
#line 325 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_LINE3;}
#line 1964 "../../source/ProgramOptions.c++"
yy353:
	yych = (char)*++p;
	switch (yych) {
	case 'm':	goto yy354;
...
#line 316 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 1993 "../../source/ProgramOptions.c++"
yy359:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy360;
...
#line 315 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_STIFFNESS;	}
#line 2040 "../../source/ProgramOptions.c++"
yy368:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy369;
...
#line 314 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS;	}
#line 2077 "../../source/ProgramOptions.c++"
yy375:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy376;
...
#line 312 "../../source/ProgramOptions.c++.re2c"
	{ return S_HELP;	}
#line 2129 "../../source/ProgramOptions.c++"
}
