/* Generated by re2c 0.13.5 on Sun Mar 28 23:23:53 2010 */
...
enum ProgramOptions::Option ProgramOptions::setCommandLineOptions(int argc, char **argv, fem::Analysis &analysis)
{
	...
	table[SG_IPS_DOMAIN_ASSIGN][S_EOA]	= 17;
	table[SG_IPS_DOMAIN_ASSIGN][S_EOL]	= 17;

	table[SN_IPS_FOLLOW_S_ASSIGN][S_FE_ELEMENT]	= 12;
	table[SN_IPS_FOLLOW_S_ASSIGN][S_EOL]	= 100;	
	table[SN_IPS_FOLLOW_S_ASSIGN][S_IPS]	= 4;
	table[SN_IPS_FOLLOW_S_ASSIGN][S_OUTPUT_FEM_EQUATION]	= 6;

	table[SN_IPS_FOLLOW_D_ASSIGN][S_FE_ELEMENT] = 19;
	table[SN_IPS_FOLLOW_D_ASSIGN][S_EOL]	= 100;	
	table[SN_IPS_FOLLOW_D_ASSIGN][S_IPS]	= 4;
	table[SN_IPS_FOLLOW_D_ASSIGN][S_OUTPUT_FEM_EQUATION]	= 6;

	table[SG_OUTPUT_EQUATION_ASSIGN][S_EOA] = 30;
	table[SG_OUTPUT_EQUATION_ASSIGN][S_EOL] = 30;
	...
	while(ss.size() > 0)
	{
		...
		else
		{
			...
			switch(table[ss.top()][symbol])
			{
				...
				case 19: // <IPs follow domain assignment>	::= <IPs first assignment> <G IPs domain assign> <end field>
					ss.pop();
					ss.push(SN_END_FIELD);
					ss.push(SG_IPS_DOMAIN_ASSIGN);
					ss.push(SN_IPS_FIRST_ASSIGN);
				...
				case 30: // <G output equation assign>	::= 
					ss.pop();
...
#line 265 "../../source/ProgramOptions.c++"
{
	char yych;
...
#line 311 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 304 "../../source/ProgramOptions.c++"
yy4:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy158;
...
#line 365 "../../source/ProgramOptions.c++"
yy15:
	++p;
...
#line 370 "../../source/ProgramOptions.c++"
yy17:
	++p;
	yych = (char)*p;
	goto yy21;
...
#line 378 "../../source/ProgramOptions.c++"
yy19:
	yych = (char)*++p;
	goto yy3;
yy20:
...
#line 673 "../../source/ProgramOptions.c++"
yy82:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy83;
...
#line 822 "../../source/ProgramOptions.c++"
yy114:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy120;
...
#line 840 "../../source/ProgramOptions.c++"
yy118:
	++p;
...
#line 273 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 1015 "../../source/ProgramOptions.c++"
yy158:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy159;
...
#line 1062 "../../source/ProgramOptions.c++"
yy167:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy168;
...
#line 1178 "../../source/ProgramOptions.c++"
yy187:
	yych = (char)*++p;
	switch (yych) {
	case 's':	goto yy188;
...
#line 270 "../../source/ProgramOptions.c++.re2c"
	{ return S_VERSION;	}
#line 1224 "../../source/ProgramOptions.c++"
yy197:
	yych = (char)*++p;
	switch (yych) {
	case 'l':	goto yy198;
...
#line 269 "../../source/ProgramOptions.c++.re2c"
	{ return S_HELP;	}
#line 1241 "../../source/ProgramOptions.c++"
}
...
#line 360 "../../source/ProgramOptions.c++.re2c"
	{ return S_UNKNOWN;	}
#line 1289 "../../source/ProgramOptions.c++"
yy205:
	yych = (char)*(q = ++p);
	switch (yych) {
	case 't':	goto yy359;
...
#line 356 "../../source/ProgramOptions.c++.re2c"
	{ return S_SUBARG_SEPARATOR; }
#line 1350 "../../source/ProgramOptions.c++"
yy216:
	++p;
...
#line 1355 "../../source/ProgramOptions.c++"
yy218:
	++p;
	yych = (char)*p;
	goto yy222;
...
#line 358 "../../source/ProgramOptions.c++.re2c"
	{ return S_INTEGER;	}
#line 1363 "../../source/ProgramOptions.c++"
yy220:
	yych = (char)*++p;
	goto yy204;
yy221:
...
#line 349 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE4;}
#line 1411 "../../source/ProgramOptions.c++"
yy229:
	++p;
#line 350 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_EDGE5;}
#line 1416 "../../source/ProgramOptions.c++"
yy231:
	++p;
...
#line 337 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM18;}
#line 1540 "../../source/ProgramOptions.c++"
yy258:
	++p;
#line 341 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_PRISM15;}
#line 1545 "../../source/ProgramOptions.c++"
yy260:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy261;
...
#line 1658 "../../source/ProgramOptions.c++"
yy283:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy284;
...
#line 1670 "../../source/ProgramOptions.c++"
yy286:
	++p;
#line 336 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_HEXAHEDRON27;}
#line 1675 "../../source/ProgramOptions.c++"
yy288:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy289;
...
#line 1741 "../../source/ProgramOptions.c++"
yy301:
	++p;
#line 339 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_QUADRANGLE8;}
#line 1746 "../../source/ProgramOptions.c++"
yy303:
	yych = (char)*++p;
	switch (yych) {
	case 't':	goto yy323;
...
#line 1802 "../../source/ProgramOptions.c++"
yy313:
	++p;
#line 333 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_TRIANGLE6;}
#line 1807 "../../source/ProgramOptions.c++"
yy315:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy321;
...
#line 1825 "../../source/ProgramOptions.c++"
yy319:
	++p;
...
#line 325 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_LINE2;}
#line 1966 "../../source/ProgramOptions.c++"
yy351:
	++p;
#line 332 "../../source/ProgramOptions.c++.re2c"
	{return S_FE_LINE3;}
#line 1971 "../../source/ProgramOptions.c++"
yy353:
	yych = (char)*++p;
	switch (yych) {
	case 'm':	goto yy354;
...
#line 323 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_DOMAIN;	}
#line 2000 "../../source/ProgramOptions.c++"
yy359:
	yych = (char)*++p;
	switch (yych) {
	case 'i':	goto yy360;
...
#line 322 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS_STIFFNESS;	}
#line 2047 "../../source/ProgramOptions.c++"
yy368:
	yych = (char)*++p;
	switch (yych) {
	case 'h':	goto yy369;
...
#line 321 "../../source/ProgramOptions.c++.re2c"
	{ return S_IPS;	}
#line 2084 "../../source/ProgramOptions.c++"
yy375:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy376;
...
#line 320 "../../source/ProgramOptions.c++.re2c"
	{ return S_VERSION;	}
#line 2119 "../../source/ProgramOptions.c++"
yy382:
	yych = (char)*++p;
	switch (yych) {
	case 'l':	goto yy383;
...
#line 319 "../../source/ProgramOptions.c++.re2c"
	{ return S_HELP;	}
#line 2136 "../../source/ProgramOptions.c++"
}
