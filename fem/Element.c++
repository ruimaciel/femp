/* Generated by re2c 0.13.5 on Fri Jan  1 23:50:39 2010 */
...
enum Element::Error Element::set(Type type, std::vector<size_t> nodes)
{
	switch(type)
	{
		...
		case FE_TETRAHEDRON10:
			if(nodes.size() != 10)
			{
				std::cerr << "error: FE_TETRAHEDRON10 needs 10 nodes, has " << nodes.size() << std::endl;
				return ERR_NODE_NUMBER;
			}
			break;
		...
		case FE_HEXAHEDRON27:
			if(nodes.size() != 27)
			{
				std::cerr << "error: FE_HEXAHEDRON27 needs 27 nodes" << std::endl;
				return ERR_NODE_NUMBER;
			}
			break;
		default:
...
#line 116 "fem/Element.c++.re2c"
	{return FE_EDGE4;}
#line 182 "fem/Element.c++"
yy17:
	++p;
#line 117 "fem/Element.c++.re2c"
	{return FE_EDGE5;}
#line 187 "fem/Element.c++"
yy19:
	++p;
#line 118 "fem/Element.c++.re2c"
	{return FE_EDGE6;}
#line 192 "fem/Element.c++"
yy21:
	yych = (char)*++p;
	switch (yych) {
	case 'r':	goto yy22;
...
#line 97 "fem/Element.c++.re2c"
	{return FE_PRISM6;}
#line 306 "fem/Element.c++"
yy44:
	++p;
#line 104 "fem/Element.c++.re2c"
	{return FE_PRISM18;}
#line 311 "fem/Element.c++"
yy46:
	++p;
#line 108 "fem/Element.c++.re2c"
	{return FE_PRISM15;}
#line 316 "fem/Element.c++"
yy48:
	yych = (char)*++p;
	switch (yych) {
	case 'a':	goto yy49;
...
#line 98 "fem/Element.c++.re2c"
	{return FE_PYRAMID5;}
#line 359 "fem/Element.c++"
yy56:
	++p;
#line 105 "fem/Element.c++.re2c"
	{return FE_PYRAMID14;}
#line 364 "fem/Element.c++"
yy58:
	++p;
#line 109 "fem/Element.c++.re2c"
	{return FE_PYRAMID13;}
#line 369 "fem/Element.c++"
yy60:
	yych = (char)*++p;
	switch (yych) {
	case 'x':	goto yy61;
...
#line 93 "fem/Element.c++.re2c"
	{return FE_TRIANGLE3;}
#line 573 "fem/Element.c++"
yy101:
	++p;
#line 100 "fem/Element.c++.re2c"
	{return FE_TRIANGLE6;}
#line 578 "fem/Element.c++"
yy103:
	yych = (char)*++p;
	switch (yych) {
	case '0':	goto yy109;
...
#line 92 "fem/Element.c++.re2c"
	{return FE_LINE2;}
#line 737 "fem/Element.c++"
yy139:
	++p;
#line 99 "fem/Element.c++.re2c"
	{return FE_LINE3;}
#line 742 "fem/Element.c++"
}
