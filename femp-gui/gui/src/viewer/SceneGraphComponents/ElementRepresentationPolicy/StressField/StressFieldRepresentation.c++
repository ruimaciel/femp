...
void StressFieldRepresentation::render(float const& diameter, float const& max, float const& min, bool const& render_positive, bool const& render_negative, ViewportColors const& colors) const
{
...
void StressFieldRepresentation::push(fem::Point3D const& pos, std::array<fem::Point3D, 3> const& directions, std::array<float, 3> const& stresses)
{
    StressTensor tensor;
