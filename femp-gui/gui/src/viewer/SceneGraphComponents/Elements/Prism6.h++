#ifndef SGC_ELEMENT_PRISM6_HPP
#define SGC_ELEMENT_PRISM6_HPP
...
public:
	...
	*/
    Prism6(fem::element_ref_t const&, fem::Element& reference_element, ElementRepresentationPolicy* representation, DisplacementsRepresentationPolicy* displacements);
