...
template<typename T>
void Quadrangle8<T>::setCoordinates()
{
	...
	this->coordinates[ 4] = point(	0,	-1,	0);
	this->coordinates[ 5] = point(	1,	0,	0);
	this->coordinates[ 6] = point(	0,	1,	0);
	this->coordinates[ 7] = point(	-1,	0,	0);
}
