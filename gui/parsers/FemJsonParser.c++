/* Generated by re2c 0.13.5 on Tue Aug  9 10:39:44 2011 */
		...
		else
		{
			...
			switch( table[(enum NonTerminalTokens)nonterminal_token][terminal_token] )	
			{
				...
				default:
					...
					this->error.message = "Unknown error while parsing line " + line_number;
...
#line 1283 "parsers/FemJsonParser.c++"
	{
		unsigned char yych;
...
#line 1345 "parsers/FemJsonParser.c++"
yy4:
		yyaccept = 1;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy5:
#line 1332 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NATURAL_NUMBER);	}
#line 1358 "parsers/FemJsonParser.c++"
yy6:
		yyaccept = 1;
		yych = *(marker = ++pos);
		goto yy62;
...
#line 1448 "parsers/FemJsonParser.c++"
yy26:
		++pos;
		yych = *pos;
		goto yy32;
...
#line 1498 "parsers/FemJsonParser.c++"
yy38:
		yych = *++pos;
		switch (yych) {
		case 'l':	goto yy39;
...
#line 1521 "parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
#line 1538 "parsers/FemJsonParser.c++"
yy47:
		yyaccept = 2;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1551 "parsers/FemJsonParser.c++"
yy49:
		yyaccept = 2;
		marker = ++pos;
...
#line 1829 "parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
#line 1870 "parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
yy102:
		++pos;
#line 1324 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE6);	}
#line 1942 "parsers/FemJsonParser.c++"
yy104:
		++pos;
#line 1323 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE3);	}
#line 1947 "parsers/FemJsonParser.c++"
yy106:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy107;
...
#line 2047 "parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
yy138:
		++pos;
#line 1321 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_SURFACE_LOADS);	}
#line 2124 "parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
yy152:
		++pos;
#line 1327 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE9);	}
#line 2203 "parsers/FemJsonParser.c++"
yy154:
		++pos;
#line 1326 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE8);	}
#line 2208 "parsers/FemJsonParser.c++"
yy156:
		++pos;
#line 1325 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE4);	}
#line 2213 "parsers/FemJsonParser.c++"
yy158:
		yych = *++pos;
		switch (yych) {
		case 'i':	goto yy159;
...
yy166:
		++pos;
#line 1310 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM18);	}
#line 2268 "parsers/FemJsonParser.c++"
yy168:
		++pos;
#line 1309 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM15);	}
#line 2273 "parsers/FemJsonParser.c++"
yy170:
		++pos;
#line 1308 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM6);	}
#line 2278 "parsers/FemJsonParser.c++"
yy172:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy206;
...
yy184:
		++pos;
#line 1320 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODAL_LOADS);	}
#line 2358 "parsers/FemJsonParser.c++"
yy186:
		++pos;
#line 1316 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODE);	}
#line 2363 "parsers/FemJsonParser.c++"
yy188:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy192;
...
yy204:
		++pos;
#line 1314 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODE_RESTRICTIONS);	}
#line 2457 "parsers/FemJsonParser.c++"
yy206:
		++pos;
#line 1298 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NU);	}
#line 2462 "parsers/FemJsonParser.c++"
yy208:
		yych = *++pos;
		switch (yych) {
		case 't':	goto yy209;
...
yy215:
		++pos;
#line 1311 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_MATERIAL);	}
#line 2510 "parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
#line 2521 "parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
yy234:
		++pos;
#line 1315 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LOAD_PATTERNS);	}
#line 2610 "parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
yy248:
		++pos;
#line 1300 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LINEAR_ELASTIC);	}
#line 2687 "parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
#line 2710 "parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
yy266:
		++pos;
#line 1305 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON8);	}
#line 2783 "parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
yy270:
		++pos;
#line 1307 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON27);	}
#line 2800 "parsers/FemJsonParser.c++"
yy272:
		++pos;
#line 1306 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON20);	}
#line 2805 "parsers/FemJsonParser.c++"
yy274:
		yych = *++pos;
		switch (yych) {
		case 'o':	goto yy275;
...
yy279:
		++pos;
#line 1312 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_GROUPS);	}
#line 2840 "parsers/FemJsonParser.c++"
yy281:
		yych = *++pos;
		switch (yych) {
		case 'm':	goto yy294;
...
yy287:
		++pos;
#line 1329 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2882 "parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
yy290:
		++pos;
#line 1330 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2893 "parsers/FemJsonParser.c++"
yy292:
		++pos;
#line 1299 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FY);	}
#line 2898 "parsers/FemJsonParser.c++"
yy294:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy295;
...
#line 2909 "parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
yy322:
		++pos;
#line 1322 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DOMAIN_LOADS);	}
#line 3051 "parsers/FemJsonParser.c++"
yy324:
		++pos;
#line 1319 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DZ);	}
#line 3056 "parsers/FemJsonParser.c++"
yy326:
		++pos;
#line 1318 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DY);	}
#line 3061 "parsers/FemJsonParser.c++"
yy328:
		++pos;
#line 1317 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DX);	}
#line 3066 "parsers/FemJsonParser.c++"
yy330:
		++pos;
...
#line 3118 "parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
#line 3135 "parsers/FemJsonParser.c++"
	}
