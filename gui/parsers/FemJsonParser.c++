/* Generated by re2c 0.13.5 on Tue Aug  9 22:27:49 2011 */
...
#line 1420 "parsers/FemJsonParser.c++"
yy6:
		yyaccept = 1;
		yych = *(marker = ++pos);
		goto yy62;
...
#line 1459 "parsers/FemJsonParser.c++"
yy11:
		++pos;
...
#line 1469 "parsers/FemJsonParser.c++"
yy15:
		++pos;
...
#line 1510 "parsers/FemJsonParser.c++"
yy26:
		++pos;
		yych = *pos;
		goto yy32;
...
#line 1583 "parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
#line 1600 "parsers/FemJsonParser.c++"
yy47:
		yyaccept = 2;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1613 "parsers/FemJsonParser.c++"
yy49:
		yyaccept = 2;
		marker = ++pos;
...
#line 1891 "parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
#line 1932 "parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
yy124:
		++pos;
#line 1356 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TYPE);	}
#line 2109 "parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
#line 2186 "parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
#line 2442 "parsers/FemJsonParser.c++"
yy192:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy193;
...
#line 2572 "parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
#line 2583 "parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
#line 2672 "parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
#line 2749 "parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
#line 2772 "parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
#line 2845 "parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
#line 2867 "parsers/FemJsonParser.c++"
yy274:
		yych = *++pos;
		switch (yych) {
		case 'o':	goto yy275;
...
#line 2902 "parsers/FemJsonParser.c++"
yy281:
		yych = *++pos;
		switch (yych) {
		case 'm':	goto yy294;
...
#line 2944 "parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
#line 2971 "parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
#line 3113 "parsers/FemJsonParser.c++"
yy324:
		++pos;
...
#line 3180 "parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
#line 3197 "parsers/FemJsonParser.c++"
	}
