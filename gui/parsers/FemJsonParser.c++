/* Generated by re2c 0.13.5 on Wed Apr  4 15:46:11 2012 */
...
#line 1427 "parsers/FemJsonParser.c++"
yy4:
		yyaccept = 1;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1530 "parsers/FemJsonParser.c++"
yy26:
		++pos;
		yych = *pos;
		goto yy32;
...
#line 1543 "parsers/FemJsonParser.c++"
yy30:
		yych = *++pos;
		goto yy3;
yy31:
...
#line 1580 "parsers/FemJsonParser.c++"
yy38:
		yych = *++pos;
		switch (yych) {
		case 'l':	goto yy39;
...
#line 1603 "parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
#line 1620 "parsers/FemJsonParser.c++"
yy47:
		yyaccept = 2;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1911 "parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
yy89:
		++pos;
#line 1374 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_VERSION);	}
#line 1952 "parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
#line 2129 "parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
#line 2206 "parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
#line 2350 "parsers/FemJsonParser.c++"
yy168:
		++pos;
#line 1391 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM15);	}
#line 2355 "parsers/FemJsonParser.c++"
yy170:
		++pos;
#line 1390 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM6);	}
#line 2360 "parsers/FemJsonParser.c++"
yy172:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy206;
...
#line 2592 "parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
#line 2603 "parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
#line 2692 "parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
#line 2769 "parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
#line 2792 "parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
#line 2865 "parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
yy272:
		++pos;
#line 1388 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON20);	}
#line 2887 "parsers/FemJsonParser.c++"
yy274:
		yych = *++pos;
		switch (yych) {
		case 'o':	goto yy275;
...
#line 2922 "parsers/FemJsonParser.c++"
yy281:
		yych = *++pos;
		switch (yych) {
		case 'm':	goto yy294;
...
#line 2964 "parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
#line 2991 "parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
yy339:
		++pos;
#line 1377 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_3D_SOLID);	}
#line 3200 "parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
#line 3217 "parsers/FemJsonParser.c++"
	}
