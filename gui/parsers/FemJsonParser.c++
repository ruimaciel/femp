/* Generated by re2c 0.13.5 on Sun May 12 01:03:53 2013 */
...
#line 1395 "parsers/FemJsonParser.c++"
	{
		unsigned char yych;
...
yy3:
#line 1462 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_UNKNOWN); 		}
#line 1457 "parsers/FemJsonParser.c++"
yy4:
		yyaccept = 1;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1470 "parsers/FemJsonParser.c++"
yy6:
		yyaccept = 1;
		yych = *(marker = ++pos);
		goto yy62;
...
yy24:
		++pos;
#line 1458 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_EOF);		}
#line 1560 "parsers/FemJsonParser.c++"
yy26:
		++pos;
		yych = *pos;
		goto yy32;
yy27:
#line 1460 "parsers/FemJsonParser.c++.re2c"
		{ goto starting_point;				}
#line 1568 "parsers/FemJsonParser.c++"
yy28:
		++pos;
#line 1461 "parsers/FemJsonParser.c++.re2c"
		{ line_number++; goto starting_point;		}
#line 1573 "parsers/FemJsonParser.c++"
yy30:
		yych = *++pos;
		goto yy3;
yy31:
...
#line 1610 "parsers/FemJsonParser.c++"
yy38:
		yych = *++pos;
		switch (yych) {
		case 'l':	goto yy39;
...
#line 1633 "parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
#line 1650 "parsers/FemJsonParser.c++"
yy47:
		yyaccept = 2;
		yych = *(marker = ++pos);
		switch (yych) {
...
#line 1663 "parsers/FemJsonParser.c++"
yy49:
		yyaccept = 2;
		marker = ++pos;
...
#line 1941 "parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
#line 1982 "parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
#line 2159 "parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
#line 2236 "parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
#line 2315 "parsers/FemJsonParser.c++"
yy154:
		++pos;
#line 1438 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE8);	}
#line 2320 "parsers/FemJsonParser.c++"
yy156:
		++pos;
#line 1437 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE4);	}
#line 2325 "parsers/FemJsonParser.c++"
yy158:
		yych = *++pos;
		switch (yych) {
		case 'i':	goto yy159;
...
#line 2492 "parsers/FemJsonParser.c++"
yy192:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy193;
...
#line 2622 "parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
#line 2633 "parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
#line 2722 "parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
#line 2799 "parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
#line 2822 "parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
#line 2895 "parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
#line 2994 "parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
#line 3010 "parsers/FemJsonParser.c++"
yy294:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy295;
...
#line 3021 "parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
#line 3183 "parsers/FemJsonParser.c++"
yy332:
		yych = *++pos;
		switch (yych) {
		case ' ':	goto yy333;
...
#line 3230 "parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
#line 3247 "parsers/FemJsonParser.c++"
	}
#line 1463 "parsers/FemJsonParser.c++.re2c"
...
void FemJsonParser::setParserTable()
{
	...
	table	[NT_REFERENCE]		[TT_NATURAL_NUMBER]	=	PR_REFERENCE_ERROR;
