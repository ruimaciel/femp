/* Generated by re2c 0.13.5 on Mon Aug  8 11:16:51 2011 */
#line 1 "../../source/parsers/FemJsonParser.c++.re2c"
...
#include "../fem-2.0/FemException.h++"
...
void FemJsonParser::operator() (std::istream &file, FemModel &model)
{
	...
	while(!ss.empty())
	{
		...
		else
		{
			...
			switch( table[(enum NonTerminalTokens)nonterminal_token][terminal_token] )	
			{
				...
				case PR_LABEL_SET:
					//TODO push label to a temp variable
					break;
				...
				case PR_MULTIREFERENCE_1:
					ss.push(NT_REFERENCE);
					break;

				case PR_MULTIREFERENCE_2:
					ss.push(TT_ARRAY_CLOSE);
					ss.push(NT_REFERENCE);
					ss.push(TT_VALUE_SEPARATOR);
					ss.push(NT_REFERENCE);
				...
				case PR_FLOAT_SET:
					//TODO push float to temp double list
					break;

				case PR_INT_TO_FLOAT_SET:
					//TODO push double to temp double list
					break;
				...
				case PR_NODE_GROUP_FOLLOW_2:
					break;
				//TODO finish implementing node groups
				...
				default:
					throw FemException("unknown token");
					return;
					break;
			}
		}
...
#line 1151 "../../source/parsers/FemJsonParser.c++"
	{
		unsigned char yych;
...
yy3:
#line 1218 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_UNKNOWN); 		}
#line 1213 "../../source/parsers/FemJsonParser.c++"
yy4:
		yyaccept = 1;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy5:
#line 1200 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NATURAL_NUMBER);	}
#line 1226 "../../source/parsers/FemJsonParser.c++"
yy6:
		yyaccept = 1;
		yych = *(marker = ++pos);
		goto yy62;
...
yy9:
		++pos;
#line 1204 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_OBJECT_OPEN); 	}
#line 1265 "../../source/parsers/FemJsonParser.c++"
yy11:
		++pos;
#line 1205 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_OBJECT_CLOSE); 	}
#line 1270 "../../source/parsers/FemJsonParser.c++"
yy13:
		++pos;
#line 1206 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_ARRAY_OPEN); 	}
#line 1275 "../../source/parsers/FemJsonParser.c++"
yy15:
		++pos;
#line 1207 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_ARRAY_CLOSE); 	}
#line 1280 "../../source/parsers/FemJsonParser.c++"
yy17:
		++pos;
#line 1208 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NAME_SEPARATOR);	}
#line 1285 "../../source/parsers/FemJsonParser.c++"
yy19:
		++pos;
#line 1209 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_VALUE_SEPARATOR);	}
#line 1290 "../../source/parsers/FemJsonParser.c++"
yy21:
		yyaccept = 0;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy24:
		++pos;
#line 1214 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_EOF);		}
#line 1316 "../../source/parsers/FemJsonParser.c++"
yy26:
		++pos;
		yych = *pos;
		goto yy32;
yy27:
#line 1216 "../../source/parsers/FemJsonParser.c++.re2c"
		{ goto starting_point;				}
#line 1324 "../../source/parsers/FemJsonParser.c++"
yy28:
		++pos;
#line 1217 "../../source/parsers/FemJsonParser.c++.re2c"
		{ line_number++; goto starting_point;		}
#line 1329 "../../source/parsers/FemJsonParser.c++"
yy30:
		yych = *++pos;
		goto yy3;
yy31:
...
yy36:
		++pos;
#line 1212 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NULL);	}
#line 1366 "../../source/parsers/FemJsonParser.c++"
yy38:
		yych = *++pos;
		switch (yych) {
		case 'l':	goto yy39;
...
yy41:
		++pos;
#line 1211 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_FALSE);	}
#line 1389 "../../source/parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
yy45:
		++pos;
#line 1210 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_TRUE);	}
#line 1406 "../../source/parsers/FemJsonParser.c++"
yy47:
		yyaccept = 2;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy48:
#line 1201 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_FLOAT_NUMBER);	}
#line 1419 "../../source/parsers/FemJsonParser.c++"
yy49:
		yyaccept = 2;
		marker = ++pos;
...
yy81:
		++pos;
#line 1203 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_TEXT_STRING);	}
#line 1697 "../../source/parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
yy89:
		++pos;
#line 1160 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_VERSION);	}
#line 1738 "../../source/parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
yy102:
		++pos;
#line 1192 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE6);	}
#line 1810 "../../source/parsers/FemJsonParser.c++"
yy104:
		++pos;
#line 1191 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE3);	}
#line 1815 "../../source/parsers/FemJsonParser.c++"
yy106:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy107;
...
yy118:
		++pos;
#line 1172 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TETRAHEDRON10);	}
#line 1893 "../../source/parsers/FemJsonParser.c++"
yy120:
		++pos;
#line 1171 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TETRAHEDRON4);	}
#line 1898 "../../source/parsers/FemJsonParser.c++"
yy122:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy123;
...
yy124:
		++pos;
#line 1162 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TYPE);	}
#line 1915 "../../source/parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
yy138:
		++pos;
#line 1189 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_SURFACE_LOADS);	}
#line 1992 "../../source/parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
yy152:
		++pos;
#line 1195 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE9);	}
#line 2071 "../../source/parsers/FemJsonParser.c++"
yy154:
		++pos;
#line 1194 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE8);	}
#line 2076 "../../source/parsers/FemJsonParser.c++"
yy156:
		++pos;
#line 1193 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE4);	}
#line 2081 "../../source/parsers/FemJsonParser.c++"
yy158:
		yych = *++pos;
		switch (yych) {
		case 'i':	goto yy159;
...
yy166:
		++pos;
#line 1178 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM18);	}
#line 2136 "../../source/parsers/FemJsonParser.c++"
yy168:
		++pos;
#line 1177 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM15);	}
#line 2141 "../../source/parsers/FemJsonParser.c++"
yy170:
		++pos;
#line 1176 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM6);	}
#line 2146 "../../source/parsers/FemJsonParser.c++"
yy172:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy206;
...
yy184:
		++pos;
#line 1188 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODAL_LOADS);	}
#line 2226 "../../source/parsers/FemJsonParser.c++"
yy186:
		++pos;
#line 1184 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODE);	}
#line 2231 "../../source/parsers/FemJsonParser.c++"
yy188:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy192;
...
yy190:
		++pos;
#line 1169 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODES);	}
#line 2248 "../../source/parsers/FemJsonParser.c++"
yy192:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy193;
...
yy204:
		++pos;
#line 1182 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODE_RESTRICTIONS);	}
#line 2325 "../../source/parsers/FemJsonParser.c++"
yy206:
		++pos;
#line 1166 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NU);	}
#line 2330 "../../source/parsers/FemJsonParser.c++"
yy208:
		yych = *++pos;
		switch (yych) {
		case 't':	goto yy209;
...
yy215:
		++pos;
#line 1179 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_MATERIAL);	}
#line 2378 "../../source/parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
yy218:
		++pos;
#line 1164 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_MATERIALS);	}
#line 2389 "../../source/parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
yy234:
		++pos;
#line 1183 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LOAD_PATTERNS);	}
#line 2478 "../../source/parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
yy248:
		++pos;
#line 1168 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LINEAR_ELASTIC);	}
#line 2555 "../../source/parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
yy253:
		++pos;
#line 1158 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LABEL);	}
#line 2578 "../../source/parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
yy266:
		++pos;
#line 1173 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON8);	}
#line 2651 "../../source/parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
yy270:
		++pos;
#line 1175 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON27);	}
#line 2668 "../../source/parsers/FemJsonParser.c++"
yy272:
		++pos;
#line 1174 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON20);	}
#line 2673 "../../source/parsers/FemJsonParser.c++"
yy274:
		yych = *++pos;
		switch (yych) {
		case 'o':	goto yy275;
...
yy279:
		++pos;
#line 1180 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_GROUPS);	}
#line 2708 "../../source/parsers/FemJsonParser.c++"
yy281:
		yych = *++pos;
		switch (yych) {
		case 'm':	goto yy294;
...
yy287:
		++pos;
#line 1197 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2750 "../../source/parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
yy290:
		++pos;
#line 1198 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2761 "../../source/parsers/FemJsonParser.c++"
yy292:
		++pos;
#line 1167 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FY);	}
#line 2766 "../../source/parsers/FemJsonParser.c++"
yy294:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy295;
...
yy295:
		++pos;
#line 1159 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FEM);	}
#line 2777 "../../source/parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
yy304:
		++pos;
#line 1196 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_ELEMENT);	}
#line 2825 "../../source/parsers/FemJsonParser.c++"
yy306:
		++pos;
#line 1170 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_ELEMENTS);	}
#line 2830 "../../source/parsers/FemJsonParser.c++"
yy308:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy328;
...
yy322:
		++pos;
#line 1190 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DOMAIN_LOADS);	}
#line 2919 "../../source/parsers/FemJsonParser.c++"
yy324:
		++pos;
#line 1187 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DZ);	}
#line 2924 "../../source/parsers/FemJsonParser.c++"
yy326:
		++pos;
#line 1186 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DY);	}
#line 2929 "../../source/parsers/FemJsonParser.c++"
yy328:
		++pos;
#line 1185 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DX);	}
#line 2934 "../../source/parsers/FemJsonParser.c++"
yy330:
		++pos;
#line 1165 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_E);	}
#line 2939 "../../source/parsers/FemJsonParser.c++"
yy332:
		yych = *++pos;
		switch (yych) {
		case ' ':	goto yy333;
...
yy339:
		++pos;
#line 1163 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_3D_SOLID);	}
#line 2986 "../../source/parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
yy343:
		++pos;
#line 1161 "../../source/parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_V1_0);	}
#line 3003 "../../source/parsers/FemJsonParser.c++"
	}
#line 1219 "../../source/parsers/FemJsonParser.c++.re2c"
...
void FemJsonParser::setParserTable()
{
	...
	table	[NT_REFERENCE_LIST]	[TT_NATURAL_NUMBER]	=	PR_REFERENCE_LIST_1;
	...
	table	[NT_MULTI_REFERENCE]		[TT_NATURAL_NUMBER]	=	PR_MULTIREFERENCE_1;
	table	[NT_MULTI_REFERENCE]		[TT_ARRAY_OPEN]		=	PR_MULTIREFERENCE_2;
	...
	table	[NT_NODE_GROUP_LIST]		[TT_OBJECT_OPEN]	=	PR_NODE_GROUP_LIST_1;
	...
	table	[NT_NODE_GROUP_FOLLOW_FOLLOW]	[TT_VALUE_SEPARATOR]	=	PR_NODE_GROUP_FOLLOW_1;
	table	[NT_NODE_GROUP_FOLLOW_FOLLOW]	[TT_ARRAY_CLOSE]	=	PR_NODE_GROUP_FOLLOW_2;

	table	[NT_ELEMENT_GROUP_LIST]		[TT_OBJECT_OPEN]	=	PR_ELEMENT_GROUP_LIST_1;
...
enum FemJsonParser::TerminalTokens FemJsonParser::lexerReturnProcedures(TerminalTokens tt)
{
	...
	{
		case TT_TEXT_STRING:
			temp_text_string.assign(tok+1,pos-tok-2);
			std::cout << temp_text_string << std::endl;
		...
		case TT_NATURAL_NUMBER:
			{
				std::string temp;
				temp.assign(tok,pos-tok);
				temp_natural = boost::lexical_cast<unsigned long int>(temp);
			}
		...
		case TT_FLOAT_NUMBER:
			{
				std::string temp;
				temp.assign(tok,pos-tok);
				temp_float = boost::lexical_cast<double>(temp);
			}
...
void FemJsonParser::fill(std::istream &file)
{
	if(file.good())
	{
		...
		file.read(buffer + count, 1024-count);
