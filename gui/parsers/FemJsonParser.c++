/* Generated by re2c 0.13.5 on Mon Aug  8 17:12:40 2011 */
...
#line 1236 "parsers/FemJsonParser.c++"
	{
		unsigned char yych;
...
yy3:
#line 1303 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_UNKNOWN); 		}
#line 1298 "parsers/FemJsonParser.c++"
yy4:
		yyaccept = 1;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy5:
#line 1285 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NATURAL_NUMBER);	}
#line 1311 "parsers/FemJsonParser.c++"
yy6:
		yyaccept = 1;
		yych = *(marker = ++pos);
		goto yy62;
...
yy9:
		++pos;
#line 1289 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_OBJECT_OPEN); 	}
#line 1350 "parsers/FemJsonParser.c++"
yy11:
		++pos;
#line 1290 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_OBJECT_CLOSE); 	}
#line 1355 "parsers/FemJsonParser.c++"
yy13:
		++pos;
#line 1291 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_ARRAY_OPEN); 	}
#line 1360 "parsers/FemJsonParser.c++"
yy15:
		++pos;
#line 1292 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_ARRAY_CLOSE); 	}
#line 1365 "parsers/FemJsonParser.c++"
yy17:
		++pos;
#line 1293 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NAME_SEPARATOR);	}
#line 1370 "parsers/FemJsonParser.c++"
yy19:
		++pos;
#line 1294 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_VALUE_SEPARATOR);	}
#line 1375 "parsers/FemJsonParser.c++"
yy21:
		yyaccept = 0;
		yych = *(marker = ++pos);
		switch (yych) {
...
yy24:
		++pos;
#line 1299 "parsers/FemJsonParser.c++.re2c"
...
yy26:
		...
		goto yy32;
yy27:
#line 1301 "parsers/FemJsonParser.c++.re2c"
		{ goto starting_point;				}
#line 1409 "parsers/FemJsonParser.c++"
yy28:
		++pos;
#line 1302 "parsers/FemJsonParser.c++.re2c"
		{ line_number++; goto starting_point;		}
#line 1414 "parsers/FemJsonParser.c++"
yy30:
		yych = *++pos;
		goto yy3;
yy31:
...
yy36:
		++pos;
#line 1297 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_NULL);	}
#line 1451 "parsers/FemJsonParser.c++"
yy38:
		yych = *++pos;
		switch (yych) {
		case 'l':	goto yy39;
...
yy41:
		++pos;
#line 1296 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_FALSE);	}
#line 1474 "parsers/FemJsonParser.c++"
yy43:
		yych = *++pos;
		switch (yych) {
		case 'u':	goto yy44;
...
yy45:
		++pos;
#line 1295 "parsers/FemJsonParser.c++.re2c"
...
yy48:
#line 1286 "parsers/FemJsonParser.c++.re2c"
...
yy81:
		++pos;
#line 1288 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_TEXT_STRING);	}
#line 1782 "parsers/FemJsonParser.c++"
yy83:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy84;
...
yy89:
		++pos;
#line 1245 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_VERSION);	}
#line 1823 "parsers/FemJsonParser.c++"
yy91:
		yych = *++pos;
		switch (yych) {
		case 'p':	goto yy122;
...
yy102:
		++pos;
#line 1277 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE6);	}
#line 1895 "parsers/FemJsonParser.c++"
yy104:
		++pos;
#line 1276 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TRIANGLE3);	}
#line 1900 "parsers/FemJsonParser.c++"
yy106:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy107;
...
yy118:
		++pos;
#line 1257 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TETRAHEDRON10);	}
#line 1978 "parsers/FemJsonParser.c++"
yy120:
		++pos;
#line 1256 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TETRAHEDRON4);	}
#line 1983 "parsers/FemJsonParser.c++"
yy122:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy123;
...
yy124:
		++pos;
#line 1247 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_TYPE);	}
#line 2000 "parsers/FemJsonParser.c++"
yy126:
		yych = *++pos;
		switch (yych) {
		case 'r':	goto yy127;
...
yy138:
		++pos;
#line 1274 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_SURFACE_LOADS);	}
#line 2077 "parsers/FemJsonParser.c++"
yy140:
		yych = *++pos;
		switch (yych) {
		case 'a':	goto yy141;
...
yy152:
		++pos;
#line 1280 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE9);	}
#line 2156 "parsers/FemJsonParser.c++"
yy154:
		++pos;
#line 1279 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE8);	}
#line 2161 "parsers/FemJsonParser.c++"
yy156:
		++pos;
#line 1278 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_QUADRANGLE4);	}
#line 2166 "parsers/FemJsonParser.c++"
yy158:
		yych = *++pos;
		switch (yych) {
		case 'i':	goto yy159;
...
yy166:
		++pos;
#line 1263 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM18);	}
#line 2221 "parsers/FemJsonParser.c++"
yy168:
		++pos;
#line 1262 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM15);	}
#line 2226 "parsers/FemJsonParser.c++"
yy170:
		++pos;
#line 1261 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_PRISM6);	}
#line 2231 "parsers/FemJsonParser.c++"
yy172:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy206;
...
yy190:
		++pos;
#line 1254 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODES);	}
#line 2333 "parsers/FemJsonParser.c++"
yy192:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy193;
...
yy204:
		++pos;
#line 1267 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NODE_RESTRICTIONS);	}
#line 2410 "parsers/FemJsonParser.c++"
yy206:
		++pos;
#line 1251 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_NU);	}
#line 2415 "parsers/FemJsonParser.c++"
yy208:
		yych = *++pos;
		switch (yych) {
		case 't':	goto yy209;
...
yy215:
		++pos;
#line 1264 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_MATERIAL);	}
#line 2463 "parsers/FemJsonParser.c++"
yy217:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy218;
...
yy218:
		++pos;
#line 1249 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_MATERIALS);	}
#line 2474 "parsers/FemJsonParser.c++"
yy220:
		yych = *++pos;
		switch (yych) {
		case 'b':	goto yy250;
...
yy234:
		++pos;
#line 1268 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LOAD_PATTERNS);	}
#line 2563 "parsers/FemJsonParser.c++"
yy236:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy237;
...
yy248:
		++pos;
#line 1253 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LINEAR_ELASTIC);	}
#line 2640 "parsers/FemJsonParser.c++"
yy250:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy251;
...
yy253:
		++pos;
#line 1243 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_LABEL);	}
#line 2663 "parsers/FemJsonParser.c++"
yy255:
		yych = *++pos;
		switch (yych) {
		case 'x':	goto yy256;
...
yy266:
		++pos;
#line 1258 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_HEXAHEDRON8);	}
#line 2736 "parsers/FemJsonParser.c++"
yy268:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy272;
...
yy279:
		++pos;
#line 1265 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_GROUPS);	}
#line 2793 "parsers/FemJsonParser.c++"
yy281:
		yych = *++pos;
		switch (yych) {
		case 'm':	goto yy294;
...
yy287:
		++pos;
#line 1282 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2835 "parsers/FemJsonParser.c++"
yy289:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy290;
...
yy290:
		++pos;
#line 1283 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FORCE);		}
#line 2846 "parsers/FemJsonParser.c++"
yy292:
		++pos;
#line 1252 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FY);	}
#line 2851 "parsers/FemJsonParser.c++"
yy294:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy295;
...
yy295:
		++pos;
#line 1244 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_FEM);	}
#line 2862 "parsers/FemJsonParser.c++"
yy297:
		yych = *++pos;
		switch (yych) {
		case 'e':	goto yy298;
...
yy304:
		++pos;
#line 1281 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_ELEMENT);	}
#line 2910 "parsers/FemJsonParser.c++"
yy306:
		++pos;
#line 1255 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_ELEMENTS);	}
#line 2915 "parsers/FemJsonParser.c++"
yy308:
		yych = *++pos;
		switch (yych) {
		case '"':	goto yy328;
...
yy322:
		++pos;
#line 1275 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DOMAIN_LOADS);	}
#line 3004 "parsers/FemJsonParser.c++"
yy324:
		++pos;
#line 1272 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DZ);	}
#line 3009 "parsers/FemJsonParser.c++"
yy326:
		++pos;
#line 1271 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DY);	}
#line 3014 "parsers/FemJsonParser.c++"
yy328:
		++pos;
#line 1270 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_DX);	}
#line 3019 "parsers/FemJsonParser.c++"
yy330:
		++pos;
#line 1250 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_E);	}
#line 3024 "parsers/FemJsonParser.c++"
yy332:
		yych = *++pos;
		switch (yych) {
		case ' ':	goto yy333;
...
yy339:
		++pos;
#line 1248 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_3D_SOLID);	}
#line 3071 "parsers/FemJsonParser.c++"
yy341:
		yych = *++pos;
		switch (yych) {
		case '0':	goto yy342;
...
yy343:
		++pos;
#line 1246 "parsers/FemJsonParser.c++.re2c"
		{ return lexerReturnProcedures(TT_LABEL_V1_0);	}
#line 3088 "parsers/FemJsonParser.c++"
	}
#line 1304 "parsers/FemJsonParser.c++.re2c"
