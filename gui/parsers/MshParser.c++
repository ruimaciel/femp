/* Generated by re2c 0.13.5 on Tue Apr 10 15:58:20 2012 */
		...
		else
		{
			...
			switch(parser_rule) 
			{
				...
				case PR_E_ELEMENT_TYPE_SET_FORCE:
					...
					{
						//TODO finish this
						surface_load.surface_forces[i] = normalForce(surface_load, i);
					}
					index_list.clear();
...
yy199:
	...
	goto yy212;
yy200:
#line 676 "parsers/MshParser.c++.re2c"
	{
			setIndex();
...
yy243:
	++pos;
#line 744 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
