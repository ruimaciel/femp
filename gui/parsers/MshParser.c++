/* Generated by re2c 0.13.5 on Thu Apr 12 17:52:27 2012 */
...
#line 1150 "parsers/MshParser.c++"
yy109:
	++pos;
#line 625 "parsers/MshParser.c++.re2c"
	{ return TT_VERSION_2_1;	}
#line 1155 "parsers/MshParser.c++"
}
...
#line 675 "parsers/MshParser.c++.re2c"
...
#line 723 "parsers/MshParser.c++.re2c"
	{ goto std;	}
#line 1771 "parsers/MshParser.c++"
yy207:
	++pos;
#line 724 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1776 "parsers/MshParser.c++"
yy209:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
#line 748 "parsers/MshParser.c++.re2c"
	{ goto std;	}
#line 1927 "parsers/MshParser.c++"
yy241:
	++pos;
#line 749 "parsers/MshParser.c++.re2c"
	{ lex_state = 4; error.line_number++; return TT_EOL; }
#line 1932 "parsers/MshParser.c++"
yy243:
	++pos;
#line 750 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1937 "parsers/MshParser.c++"
yy245:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
#line 751 "parsers/MshParser.c++.re2c"
