/* Generated by re2c 0.13.5 on Tue Apr 10 14:48:11 2012 */
		...
		else
		{
			...
			switch(parser_rule) 
			{
				...
				case PR_E_NUMBER_OF_ELEMENTS_SET:
					model.element_list.resize(index_list.back());
					index_list.pop_back();	
					break;
...
#line 620 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1013 "parsers/MshParser.c++"
yy82:
	++pos;
#line 617 "parsers/MshParser.c++.re2c"
	{ line_number++; return TT_EOL; }
#line 1018 "parsers/MshParser.c++"
yy84:
	++pos;
#line 618 "parsers/MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1023 "parsers/MshParser.c++"
yy86:
	++pos;
	yych = *pos;
	goto yy90;
...
#line 637 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1197 "parsers/MshParser.c++"
yy118:
	++pos;
#line 634 "parsers/MshParser.c++.re2c"
	{ line_number++; return TT_EOL; }
#line 1202 "parsers/MshParser.c++"
yy120:
	++pos;
#line 635 "parsers/MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1207 "parsers/MshParser.c++"
yy122:
	++pos;
	yych = *pos;
	goto yy126;
yy123:
#line 636 "parsers/MshParser.c++.re2c"
	{ goto std;	}
#line 1215 "parsers/MshParser.c++"
yy124:
	yych = *++pos;
	goto yy117;
yy125:
...
yy135:
	++pos;
#line 633 "parsers/MshParser.c++.re2c"
	{ lex_state = 0;	return TT_CLOSE_NODES; }
#line 1277 "parsers/MshParser.c++"
yy137:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
#line 1363 "parsers/MshParser.c++"
yy148:
	++pos;
#line 647 "parsers/MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1368 "parsers/MshParser.c++"
yy150:
	++pos;
	yych = *pos;
	goto yy154;
...
#line 662 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1549 "parsers/MshParser.c++"
yy173:
	++pos;
#line 659 "parsers/MshParser.c++.re2c"
	{ line_number++; return TT_EOL; }
#line 1554 "parsers/MshParser.c++"
yy175:
	++pos;
#line 660 "parsers/MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1559 "parsers/MshParser.c++"
yy177:
	++pos;
	yych = *pos;
	goto yy181;
...
#line 1741 "parsers/MshParser.c++"
yy201:
	++pos;
#line 709 "parsers/MshParser.c++.re2c"
	{ lex_state = 4; line_number++; return TT_EOL; }
#line 1746 "parsers/MshParser.c++"
yy203:
	++pos;
#line 710 "parsers/MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1751 "parsers/MshParser.c++"
yy205:
	++pos;
	yych = *pos;
	goto yy210;
yy206:
#line 711 "parsers/MshParser.c++.re2c"
	{ goto std;	}
#line 1759 "parsers/MshParser.c++"
yy207:
	++pos;
#line 712 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1764 "parsers/MshParser.c++"
yy209:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
#line 736 "parsers/MshParser.c++.re2c"
	{ goto std;	}
#line 1915 "parsers/MshParser.c++"
yy241:
	++pos;
#line 737 "parsers/MshParser.c++.re2c"
	{ lex_state = 4; line_number++; return TT_EOL; }
#line 1920 "parsers/MshParser.c++"
yy243:
	++pos;
#line 738 "parsers/MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1925 "parsers/MshParser.c++"
yy245:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
