...
{
    qCritical() << "TensorFieldWindow::setNegativePrincipalStressesVisibility(const bool state)";
...
{
    qCritical() << "TensorFieldWindow::setPositivePrincipalStressesVisibility(const bool state)";
