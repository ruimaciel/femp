...
void GradientFieldRepresentationPolicy::tri6(fem::element_ref_t const& ref, p_index_t p1, p_index_t p2, p_index_t p3, p_index_t p4, p_index_t p5, p_index_t p6, ViewportColors& colors)
{
    assert(m_gradient != nullptr);
...
void GradientFieldRepresentationPolicy::quad9(fem::element_ref_t const& ref, p_index_t p1, p_index_t p2, p_index_t p3, p_index_t p4, p_index_t p5, p_index_t p6, p_index_t p7, p_index_t p8, p_index_t p9, ViewportColors& colors)
{
    glEnable(GL_BLEND);
    int partitions = 6; //TODO implement a better code
