...
SelectRayIntersectionOperation::SelectRayIntersectionOperation(Selection &selection, fem::Point3D const &origin, fem::Point3D const &destination, float const &radius)
{
...
void
SelectRayIntersectionOperation::visit(SGC::Element & )
{
}
