...
void
CommandLineDockWidget::standard_output(const QString &text)
{
...
void
CommandLineDockWidget::standard_error(const QString &text)
{
...
void
CommandLineDockWidget::getMessage(QString message)
{
...
void
CommandLineDockWidget::getWarning(QString message)
{
	//TODO tweak colors
...
void
CommandLineDockWidget::getError(QString message)
{
	//TODO tweak colors
...
void
CommandLineDockWidget::commandEntered(void)
{
