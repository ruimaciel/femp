...
SurfaceSubdivisionDialog::~SurfaceSubdivisionDialog()
{
}


unsigned short 
SurfaceSubdivisionDialog::scale()
{
...
void 
SurfaceSubdivisionDialog::updateSlider(int value)
{
	using namespace std;
...
void 
SurfaceSubdivisionDialog::updateSpinBox(int value)
{
	using namespace std;
