#include "ModelSurfaceTriangle3.h++"

#include "../fem/point.h++"


void ModelSurfaceTriangle3::paintGL(ViewportData &, fem::Project &project, fem::AnalysisResult<double> *result,  float &scale, ViewportColors &, fem::Surface *surface)
{
	glEnable(GL_BLEND);
	using namespace fem;
