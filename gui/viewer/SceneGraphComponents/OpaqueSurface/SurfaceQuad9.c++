...
void SurfaceQuad9::paintGL(ViewportData &, fem::Project &, fem::AnalysisResult<double> *result,  ViewportColors &, std::map<size_t, fem::Node> *node_list, fem::Surface *surface)
{
	glEnable(GL_BLEND);
