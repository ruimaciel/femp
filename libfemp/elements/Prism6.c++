...
std::vector<double> & Prism6::setN(const Point &p)
{
...
std::vector<double> & Prism6::setdNdcsi(const Point &p)
{
	return this->setdNdcsi(p.data[0], p.data[1], p.data[2]);
}


std::vector<double> & Prism6::setdNdcsi(const double &, const double &, const double &zeta)
{
	//TODO finish this
	// this->dNdcsi
...
std::vector<double> & Prism6::setdNdeta(const Point &p)
{
	return this->setdNdeta(p.data[0], p.data[1], p.data[2]);
}


std::vector<double> & Prism6::setdNdeta(const double &, const double &, const double &zeta)
{
	//TODO finish this
	// this->dNdeta
...
std::vector<double> & Prism6::setdNdzeta(const Point &p)
{
	return this->setdNdzeta(p.data[0], p.data[1], p.data[2]);
}


std::vector<double> & Prism6::setdNdzeta(const double &csi, const double &eta, const double &)
{
	//TODO finish this
	// this->dNdzeta
