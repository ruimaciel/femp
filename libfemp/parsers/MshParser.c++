/* Generated by re2c 0.13.5 on Sat Sep 30 21:25:10 2017 */
...
yy26:
	++pos;
#line 606 "MshParser.c++.re2c"
	{ lex_state = 1; return TT_OPEN_MESH_FORMAT;	}
#line 732 "MshParser.c++"
yy28:
	yych = *++pos;
	switch (yych) {
	case 'y':	goto yy29;
...
yy45:
	++pos;
#line 607 "MshParser.c++.re2c"
	{ lex_state = 2; return TT_OPEN_NODES;	}
#line 833 "MshParser.c++"
yy47:
	yych = *++pos;
	switch (yych) {
	case 't':	goto yy48;
...
yy107:
	++pos;
#line 624 "MshParser.c++.re2c"
	{ return TT_VERSION_2_1;	}
#line 1150 "MshParser.c++"
yy109:
	++pos;
#line 625 "MshParser.c++.re2c"
	{ return TT_VERSION_2_1;	}
#line 1155 "MshParser.c++"
}
...
yy113:
	++pos;
yy114:
#line 640 "MshParser.c++.re2c"
	{ 
			lex_state = 3; 
			setIndex(); 
			return TT_INDEX; 
		}
#line 1196 "MshParser.c++"
yy115:
	yych = *++pos;
	goto yy138;
yy116:
...
#line 649 "MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1209 "MshParser.c++"
yy118:
	++pos;
#line 646 "MshParser.c++.re2c"
	{ error.line_number++; return TT_EOL; }
#line 1214 "MshParser.c++"
yy120:
	++pos;
...
yy135:
	++pos;
#line 645 "MshParser.c++.re2c"
	{ lex_state = 0;	return TT_CLOSE_NODES; }
#line 1289 "MshParser.c++"
yy137:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
yy144:
#line 657 "MshParser.c++.re2c"
	{ setNumber(); return TT_NUMBER; }
#line 1367 "MshParser.c++"
yy145:
	yych = *(marker = ++pos);
	goto yy156;
yy146:
	++pos;
#line 658 "MshParser.c++.re2c"
	{ lex_state = 2; error.line_number++; return TT_EOL; }
#line 1375 "MshParser.c++"
yy148:
	++pos;
#line 659 "MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1380 "MshParser.c++"
yy150:
	++pos;
	yych = *pos;
	goto yy154;
...
yy168:
	++pos;
yy169:
#line 669 "MshParser.c++.re2c"
	{ lex_state = 5; setIndex(); return TT_INDEX; }
#line 1548 "MshParser.c++"
yy170:
	yych = *++pos;
	goto yy196;
yy171:
...
#line 674 "MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1561 "MshParser.c++"
yy173:
	++pos;
#line 671 "MshParser.c++.re2c"
	{ error.line_number++; return TT_EOL; }
#line 1566 "MshParser.c++"
yy175:
	++pos;
#line 672 "MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1571 "MshParser.c++"
yy177:
	++pos;
	yych = *pos;
	goto yy181;
...
yy193:
	++pos;
#line 670 "MshParser.c++.re2c"
	{ lex_state = 0;	return TT_CLOSE_ELEMENTS; }
#line 1659 "MshParser.c++"
yy195:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
...
#line 1753 "MshParser.c++"
yy201:
	++pos;
#line 721 "MshParser.c++.re2c"
	{ lex_state = 4; error.line_number++; return TT_EOL; }
#line 1758 "MshParser.c++"
yy203:
	++pos;
#line 722 "MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1763 "MshParser.c++"
yy205:
	++pos;
	yych = *pos;
	goto yy210;
...
yy234:
	++pos;
yy235:
#line 746 "MshParser.c++.re2c"
	{ setIndex(); return TT_INDEX; }
#line 1911 "MshParser.c++"
yy236:
	yych = *++pos;
	goto yy248;
yy237:
	++pos;
#line 747 "MshParser.c++.re2c"
	{ return TT_EOF;	}
#line 1919 "MshParser.c++"
yy239:
	++pos;
	yych = *pos;
	goto yy246;
...
#line 748 "MshParser.c++.re2c"
	{ goto std;	}
#line 1927 "MshParser.c++"
yy241:
	++pos;
#line 749 "MshParser.c++.re2c"
	{ lex_state = 4; error.line_number++; return TT_EOL; }
#line 1932 "MshParser.c++"
yy243:
	++pos;
#line 750 "MshParser.c++.re2c"
	{ return TT_UNKNOWN_TOKEN; }
#line 1937 "MshParser.c++"
yy245:
	++pos;
	if (limit <= pos) YYFILL(1);
	yych = *pos;
