...
std::vector<double>
Quadrangle4::getN(const Point3D &p) const
{
...
std::vector<double>
Quadrangle4::getdNdcsi(const Point3D &p) const
{
	// double csi = p.x();
	double eta = p.y();
...
std::vector<double>
Quadrangle4::getdNdeta(const Point3D &p) const
{
	double csi = p.x();
	// double eta = p.y();
...
Quadrangle4::getLocalCoordinates() const
{
	return {
		Point3D(	-0.5,	-0.5,	0	),
		Point3D(	0.5,	-0.5,	0	),
