...
class Matrix
    : public MatrixStoragePolicy<scalar> {
public:
...
Matrix<scalar, MatrixStoragePolicy>::Matrix(const size_t rows, const size_t columns)
    : MatrixStoragePolicy<scalar>(rows, columns)
{
}

template <typename scalar, template <typename> class MatrixStoragePolicy>
Matrix<scalar, MatrixStoragePolicy>::Matrix(Matrix<scalar, MatrixStoragePolicy>& other)
