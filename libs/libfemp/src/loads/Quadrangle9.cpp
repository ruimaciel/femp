...
std::vector<fem::Point3D> Quadrangle9::getLocalCoordinates() const {
	return {
		Point3D(-0.5, -0.5, 0), Point3D(0.5, -0.5, 0), Point3D(0.5, 0.5, 0),  Point3D(-0.5, 0.5, 0), Point3D(0.0, -0.5, 0),
		Point3D(0.5, 0.0, 0),	Point3D(0.0, 0.5, 0),  Point3D(-0.5, 0.0, 0), Point3D(0.0, 0.0, 0),
	};
}
