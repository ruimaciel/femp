...
std::vector<TetrahedronRule::QuadraturePoint> Tetrahedron4::operator()() const {
	...
	return {QuadraturePoint{w, {g1, g2, g2}}, QuadraturePoint{w, {g2, g1, g2}}, QuadraturePoint{w, {g2, g2, g1}}, QuadraturePoint{w, {g2, g2, g2}}};
}
...
std::vector<TetrahedronRule::QuadraturePoint> Tetrahedron8::operator()() const {
	...
	return {QuadraturePoint{w1, {1 - 3 * g1, g1, g1}}, QuadraturePoint{w1, {g1, 1 - 3 * g1, g1}}, QuadraturePoint{w1, {g1, g1, 1 - 3 * g1}},
			QuadraturePoint{w1, {g1, g1, g1}},		   QuadraturePoint{w2, {1 - 3 * g2, g2, g2}}, QuadraturePoint{w2, {g2, 1 - 3 * g2, g2}},
			QuadraturePoint{w2, {g2, g2, 1 - 3 * g2}}, QuadraturePoint{w2, {g2, g2, g2}}};
}

std::vector<TetrahedronRule::QuadraturePoint> Tetrahedron14::operator()() const {
	...
	const double w0 = (-1 + 6 * g1 * (2 + g1 * (-7 + 8 * g1)) + 14 * g2 - 60 * g1 * (3 + 4 * g1 * (-3 + 4 * g1)) * g2 +
					   4 * (-7 + 30 * g1 * (3 + 4 * g1 * (-3 + 4 * g1))) * g2 * g2) /
					  (120 * (g0 - g1) *
					   (g1 * (-3 + 8 * g1) + 6 * g2 + 8 * g1 * (-3 + 4 * g1) * g2 - 4 * (3 + 4 * g1 * (-3 + 4 * g1)) * g2 * g2 +
						8 * g0 * g0 * (1 + 12 * g1 * (-1 + 2 * g1) + 4 * g2 - 8 * g2 * g2) +
						g0 * (-3 - 96 * g1 * g1 + 24 * g2 * (-1 + 2 * g2) + g1 * (44 + 32 * (1 - 2 * g2) * g2))));
	const double w1 =
		(-1 - 20 * (1 + 12 * g0 * (2 * g0 - 1)) * w0 + 20 * g2 * (2 * g2 - 1) * (4 * w0 - 1)) / (20 * (1 + 12 * g1 * (2 * g1 - 1) + 4 * g2 - 8 * g2 * g2));
