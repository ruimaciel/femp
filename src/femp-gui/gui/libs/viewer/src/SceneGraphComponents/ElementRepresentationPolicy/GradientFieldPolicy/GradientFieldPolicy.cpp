...
GLfloat* GradientFieldPolicy::tri3(fem::element_ref_t const& ref, gradient_index_t p1, gradient_index_t p2, gradient_index_t p3, fem::Point3D& pos,
...
GLfloat* GradientFieldPolicy::tri6(fem::element_ref_t const& ref, gradient_index_t p1, gradient_index_t p2, gradient_index_t p3, gradient_index_t p4,
								   gradient_index_t p5, gradient_index_t p6, fem::Point3D& pos, ViewportColors& colors) {
	float gradient = 0;
...
GLfloat* GradientFieldPolicy::quad4(fem::element_ref_t const& ref, gradient_index_t p1, gradient_index_t p2, gradient_index_t p3, gradient_index_t p4,
									fem::Point3D& pos, ViewportColors& colors) {
	float gradient = 0;
...
GLfloat* GradientFieldPolicy::quad8(fem::element_ref_t const& ref, gradient_index_t p1, gradient_index_t p2, gradient_index_t p3, gradient_index_t p4,
									gradient_index_t p5, gradient_index_t p6, gradient_index_t p7, gradient_index_t p8, fem::Point3D& pos,
									ViewportColors& colors) {
	float gradient = 0;
	...
	gradient = val(ref, p1) * N1 + val(ref, p2) * N2 + val(ref, p3) * N3 + val(ref, p4) * N4 + val(ref, p5) * N5 + val(ref, p6) * N6 + val(ref, p7) * N7 +
			   val(ref, p8) * N8;
...
GLfloat* GradientFieldPolicy::quad9(fem::element_ref_t const& ref, gradient_index_t p1, gradient_index_t p2, gradient_index_t p3, gradient_index_t p4,
									gradient_index_t p5, gradient_index_t p6, gradient_index_t p7, gradient_index_t p8, gradient_index_t p9, fem::Point3D& pos,
									ViewportColors& colors) {
	float gradient = 0;
