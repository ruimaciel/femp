...
void SphericalBoundary::addPoint(const fem::Point3D& p) {
	/*
	given a circle and a fem::Point, if the fem::Point isn't inside the circle
	then define a new cirlce center and radius to include the new fem::Point
	*/
