...
TableFilterDialog::TableFilterDialog(QWidget* parent) : QDialog(parent) {
	setupUi(this);
...
void TableFilterDialog::toggleStrainsCheckbox(bool) {
	if (checkBoxE11->isChecked() && checkBoxE22->isChecked() && checkBoxE33->isChecked() && checkBoxE12->isChecked() && checkBoxE23->isChecked() &&
		checkBoxE13->isChecked()) {
		checkBoxStrains->setCheckState(Qt::Checked);
	} else if (!checkBoxE11->isChecked() && !checkBoxE22->isChecked() && !checkBoxE33->isChecked() && !checkBoxE12->isChecked() && !checkBoxE23->isChecked() &&
			   !checkBoxE13->isChecked()) {
...
void TableFilterDialog::toggleStressesCheckbox(bool) {
	if (checkBoxS11->isChecked() && checkBoxS22->isChecked() && checkBoxS33->isChecked() && checkBoxS12->isChecked() && checkBoxS23->isChecked() &&
		checkBoxS13->isChecked()) {
		checkBoxStresses->setCheckState(Qt::Checked);
	} else if (!checkBoxS11->isChecked() && !checkBoxS22->isChecked() && !checkBoxS33->isChecked() && !checkBoxS12->isChecked() && !checkBoxS23->isChecked() &&
			   !checkBoxS13->isChecked()) {
