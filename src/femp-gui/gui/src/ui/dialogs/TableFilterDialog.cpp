...
#define MEMBER_HELPER(XX)                                                                           \
	void TableFilterDialog::set##XX##Visible(bool state) { m_ui->checkBox##XX->setChecked(state); } \
	bool TableFilterDialog::get##XX##Visible() const { return m_ui->checkBox##XX->isChecked(); }
