...
Prism6::Prism6(fem::element_ref_t const& ref, fem::Element& reference_element, ElementRepresentationPolicy* representation,
...
void Prism6::paintGL(ViewportData&, ViewportColors& colors) {
	...
	assert(m_element->getType() == fem::Element::FE_PRISM6);
