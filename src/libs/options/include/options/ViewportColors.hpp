#ifndef FEMP_OPTIONS_VIEWPORTCOLORS_HPP
#define FEMP_OPTIONS_VIEWPORTCOLORS_HPP
...
struct ViewportColors {
	...
	std::array<GLfloat, 4> original_surface;  // displacement: for surfaces for the model in the
