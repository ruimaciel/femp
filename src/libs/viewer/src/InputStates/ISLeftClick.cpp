...
void LeftClick::press(BaseViewport* /*viewport*/, QMouseEvent* event, Input* /*input*/) {
...
void LeftClick::release(BaseViewport* viewport, QMouseEvent* event, Input* input) {
