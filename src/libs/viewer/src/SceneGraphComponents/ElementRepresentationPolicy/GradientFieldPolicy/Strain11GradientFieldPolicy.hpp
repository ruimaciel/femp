#ifndef FEMP_VIEWER_STRAIN11_GRADIENT_FIELD_POLICY_HPP
#define FEMP_VIEWER_STRAIN11_GRADIENT_FIELD_POLICY_HPP
 ...
 **/
class Strain11GradientFieldPolicy : public GradientFieldPolicy {
	protected:
