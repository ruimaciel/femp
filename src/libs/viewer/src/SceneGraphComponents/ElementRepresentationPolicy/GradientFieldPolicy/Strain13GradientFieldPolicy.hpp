#ifndef FEMP_VIEWER_STRAIN13_GRADIENT_FIELD_POLICY_HPP
#define FEMP_VIEWER_STRAIN13_GRADIENT_FIELD_POLICY_HPP
 ...
 **/
class Strain13GradientFieldPolicy : public GradientFieldPolicy {
	protected:
