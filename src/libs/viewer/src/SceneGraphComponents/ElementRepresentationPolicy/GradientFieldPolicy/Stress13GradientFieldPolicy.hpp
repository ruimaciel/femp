#ifndef FEMP_VIEWER_13_GRADIENT_FIELD_POLICY_HPP
#define FEMP_VIEWER_13_GRADIENT_FIELD_POLICY_HPP
 ...
 **/
class Stress13GradientFieldPolicy : public GradientFieldPolicy {
	protected:
