#ifndef FEMP_VIEWER_23_GRADIENT_FIELD_POLICY_HPP
#define FEMP_VIEWER_23_GRADIENT_FIELD_POLICY_HPP
 ...
 **/
class Stress23GradientFieldPolicy : public GradientFieldPolicy {
	protected:
