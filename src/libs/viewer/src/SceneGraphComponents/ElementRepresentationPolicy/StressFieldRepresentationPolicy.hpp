#ifndef FEMP_VIEWER_FEMP_VIEWER_FIELDREPRESENTATIONPOLICY_HPP
#define FEMP_VIEWER_FEMP_VIEWER_FIELDREPRESENTATIONPOLICY_HPP
...
#include "StressField/StressFieldRepresentation.hpp"

/**
Policy pattern to render stress fields
This bit was shoe-horned into the previous design, with
...
class StressFieldRepresentationPolicy : virtual public ElementRepresentationPolicy {
	...
	bool m_negative_principal_stress_visible;  // flag to represent negative
											   // principal stresses
	bool m_positive_principal_stress_visible;  // flag to represent positive
											   // principal stresses

	float m_diameter;  // diameter with wich all tensors will be represented
	float m_max,
		m_min;	// maximum value for the positive and negative principal stresses
	...
	// used to toggle the representation of positive and negative principal
	// stresses
...
#endif	// TENSORFIELDREPRESENTATIONPOLICY_HPP
