#include "Hexahedron27.hpp"

namespace SGC  // namespace for all scene graph components
{

Hexahedron27::Hexahedron27(fem::element_ref_t const& ref, fem::Element& reference_element, ElementRepresentationPolicy* representation,
