#ifndef FEMP_VIEWER_OPERATIONS_VISITOR_HPP
#define FEMP_VIEWER_OPERATIONS_VISITOR_HPP
...
/*
Base class for a Visitor pattern which is used to operate on selected scene
objects
*/
