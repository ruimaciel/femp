...
void WindowWithPostprocessing::createToolbar(QMainWindow* parent, fem::Project&) {
	...
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_11, QObject::tr("Stress 11"));
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_22, QObject::tr("Stress 22"));
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_33, QObject::tr("Stress 33"));
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_12, QObject::tr("Stress 12"));
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_13, QObject::tr("Stress 13"));
	m_postprocessingComboBox->insertItem(P_FEMP_VIEWER_23, QObject::tr("Stress 23"));
