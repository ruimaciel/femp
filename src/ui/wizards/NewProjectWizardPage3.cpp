#include "NewProjectWizardPage3.hpp"
...
#include <ui/dialogs/NewMaterialDialog.hpp>

#include "Document.hpp"	 // for the loading test

NewProjectWizardPage3::NewProjectWizardPage3(fem::Project& project) : m_project(project) {
	setupUi(this);
...
void NewProjectWizardPage3::loadMeshFile() {
	...
	if (validMeshFile()) {
		...
		// file_name = lineEditFilePath->text().toStdString();	// Qt screws up this
		// conversion
